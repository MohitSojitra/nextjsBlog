...
function index() {
  return (
    <>
      <MetaData
        title={"What is Higher Order function and why we use ?"}
        description={
          "A higher-order function is a function that takes one or more functions as arguments. Here we will see every thing about the heigher order function with understandable example."
        }
        siteUrl={"http://localhost:3000/higherOrderFunction"}
        imageUrl={"http://mohitsojitra.tech/image/higherOrderFun.jpeg"}
      />
      <Box
        style={{
          width: "100%",
        ...
        <Box style={{ width: "600px" }}>
          ...
          <Box style={{ marginTop: "2.5rem" }}>
            ...
            <Typography
              ...
              variant={"body1"}
            >
              Here you simply read a once this defination, at the and of the
              blog you return here and one more time read this defination. I
              damn sure you definetly see diffrence between before you read blog
              and after the reading of the whole blog.
            </Typography>
            ...
            <Box>
              ...
              <Typography variant={"body1"}>
                <span style={{ fontSize: "1.5rem", fontWeight: "200" }}>
                  ...
                  then what is the solution, I damn sure you already know what
                  is solution.
                </span>
              </Typography>
            ...
            <Box>
              <Typography
                ...
                style={{ fontWeight: "bold", marginTop: "3rem" }}
              >
                Q4. Now we go to one more step ahead, now i say you make one
                more function which take an array argument return square of
                those array.
              </Typography>
              <Typography
                variant={"h6"}
            ...
            <Box>
              ...
              >
                That means we here also break the rule of DRY (DO NOT REPEAT
                YOUR SELF).
              </Typography>
            ...
            <Box>
              ...
              >
                ...
                is the operational line, ex squareTheItem, add 3 and multiply
                10. so we create a another function which only do the
                operational instruction and pass that function as a argument.
              </Typography>
